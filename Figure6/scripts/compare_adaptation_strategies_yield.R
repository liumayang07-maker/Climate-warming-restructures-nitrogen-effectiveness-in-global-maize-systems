...
plot_strategy_distribution(
  ...
  distribution_prefix = "Figure6b",
  mean_difference_file = "Figure6c_games_howell_mean_differences_from_script.csv",
  pdf_name = "Figure6b_pfr_yield_distribution.pdf",
  n_y = 0,
  letter_y = 2,
  ylim_range = c(0, 28),
...
plot_strategy_distribution(
  ...
  distribution_prefix = "Figure6d",
  mean_difference_file = "Figure6e_games_howell_mean_differences_from_script.csv",
  pdf_name = "Figure6d_gfr_yield_distribution.pdf",
  n_y = -3.8,
  letter_y = -2,
  ylim_range = c(-4, 32),
